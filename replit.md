...
- **Core Features**:
    ...
    - **4-Layer DQ Rules**: Claude returns structured JSON with `field_rules[]` (Technical/Logical/Business per field), `cross_field_rules[]`, and `business_logic_warnings[]`. Rendered as a donut chart + legend in the AgentResponseCard, exported to 3 Excel sheets.
